...
#[derive(Debug)]
pub struct FluxLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FluxLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FluxLoom processing");
    
    let mut processor = FluxLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FluxLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FluxLoomProcessor::new(false);
